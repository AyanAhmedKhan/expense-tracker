...
// Mock useTheme hook
const useTheme = () => {
    // Check if dark mode is active in html class
        ...
        >
            <div className="mx-auto flex max-w-container flex-col gap-12 pt-16 sm:gap-24">
                <div className="flex flex-col items-center gap-6 text-center sm:gap-12">
                    {/* Badge */}
                    {badge && (
                        <Badge variant="outline" className="animate-appear gap-2 cursor-pointer">
                            <span className="text-muted-foreground">{badge.text}</span>
                            <a href={badge.action.href} className="flex items-center gap-1 hover:underline">
                                {badge.action.text}
