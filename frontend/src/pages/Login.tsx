    ...
    return (
        <div className="min-h-screen flex bg-gray-900 text-white">
            ...
            <motion.div
                ...
                className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-indigo-900 to-gray-900 justify-center items-center"
            >
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1611974765270-ca1258634369?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center opacity-20"></div>
                <div className="relative z-10 p-12 text-center">
                    <h2 className="text-5xl font-bold mb-6">Welcome Back</h2>
                    <p className="text-xl text-gray-300 max-w-md mx-auto">
                        Track your expenses, manage reimbursements, and stay on top of your financial goals.
                    </p>
                </div>
            </motion.div>
                ...
                >
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button
                            ...
                            className="w-full flex justify-center items-center py-3 px-4 border border-gray-700 rounded-lg shadow-sm text-sm font-medium text-gray-300 bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all"
                        >
